...
> {
  ...
  getMinInputToolbarHeight() {
    if (this.props.renderAccessory && this.props.renderTopBar && this.props.showTopBar) {
      return this.props.minInputToolbarHeight! * 4
    } else if (this.props.renderAccessory || (this.props.renderTopBar && this.props.showTopBar)) {
