...
export interface GiftedChatProps<TMessage extends IMessage = IMessage> {
  ...
  onSend?(messages: TMessage[], scrollToBottom: (animated: boolean) => void): void
  ...
  /*Custom view above the message composer */
  renderTopBar?(props: InputToolbar['props']): React.ReactNode
...
> {
  ...
  getMinInputToolbarHeight() {
    if (this.props.renderAccessory && this.props.renderTopBar) {
      return this.props.minInputToolbarHeight! * 4
    } else if (this.props.renderAccessory || this.props.renderTopBar) {
